...
class Instance(object):
    ...
    def to_dict(self):
        dict_inst = {}
        dict_inst["instance_id"] = self.instance_id
        dict_inst["label_id"] = self.label_id
        dict_inst["vert_count"] = self.vert_count
        dict_inst["med_dist"] = self.med_dist
        dict_inst["dist_conf"] = self.dist_conf
        dict_inst["box"] = self.box
        return dict_inst
...
class ScanNetEval(object):
    ...
    def print_results(self, avgs):
        ...
        line += sep + "{:>15.3f}".format(all_ap_avg) + sep
        line += sep + "{:>15.3f}".format(all_ap_50o) + sep
        line += sep + "{:>15.3f}".format(all_ap_25o) + sep
        line += sep + "{:>15.3f}".format(all_rc_avg) + sep
        line += sep + "{:>15.3f}".format(all_rc_50o) + sep
        line += sep + "{:>15.3f}".format(all_rc_25o) + sep
        print(line)
        print("")
