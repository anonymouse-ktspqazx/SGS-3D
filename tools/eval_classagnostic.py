...
from evaluation.eval_class_agnostic_anonymous import ScanNetEval, rle_decode
...
if __name__ == "__main__":
    ...
    if cfg.data.dataset_name == 'scannet200':
        ...
        pcl_path = cfg.data.gt_path  # groundtruth
        if eval_type == '2D':
            # Use existing results directory
            data_path = "results/scannet200_312_scenes"
        if eval_type == '3D':
